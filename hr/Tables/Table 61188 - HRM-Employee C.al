table 61188 "HRM-Employee (D)"
{
    ...
    fields
    {
        ...
        field(31; Status; Option)
        {
            ...
            OptionMembers = Active,Inactive,Disabled,Discharged;
        ...
        {
            OptionMembers = " ",Single,Married,Priest,Brother,Sister,"Catholic Laity",Divorced,Widow,Widower;
        ...
        field(60027; "Nationality Code"; Code[10])
        {
        ...
        field(60033; "CUEA Email Address"; Code[40])
        {
            ...
            begin
                ...
                if Sgrade.find('-') then begin
                    ...
                    if PrPeriod.find('-') then begin
                        ...
                        if SalCard1."Basic Pay" <> Sgrade."Basic Salary" then
        ...
        field(60064; "Pays Helb"; Boolean)
        {

        }
        field(60065; "clearance initiated"; Boolean)
        {

        }
        field(60066; "Allowed Workload"; Decimal)
        {

        }
        field(60067; designation; option)
        {
            OptionMembers = others,proffessor;
        }
